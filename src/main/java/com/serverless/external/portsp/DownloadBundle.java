...
public class DownloadBundle implements AutoCloseable {
     ...
     * @return A {@link BufferedReader} that decompresses and decrypts the document's contents
     * @throws com.serverless.external.portsp.exception.CryptoException Crypto exception
     * @throws IOException IO exception
     * @throws com.serverless.external.portsp.exception.MissingCharsetException The character set could not be parsed from {@link #getContentType()} and
